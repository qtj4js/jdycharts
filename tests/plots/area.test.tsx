...
import G2AreaChart from '../../src/components/area'
...
describe('Area render', () => {
  ...
  it('classname * loading * style', () => {
    ...
    const testRenderer = create(<G2AreaChart {...props} />);
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      render(<G2AreaChart {...props} {...chartProps} />, container);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      render(<G2AreaChart {...props} {...chartProps} ref={refs} />, container);
    });
